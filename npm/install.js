...
function getPlatformInfo() {
  ...
  return {
    ...
    url: `https://github.com/Blankeos/crabmd/releases/download/v${VERSION}/${BINARY_NAME}-${target}${extension}`,
  };
}
...
function logInstallFailure(error) {
  ...
  console.error("\nYou can install crabmd directly using:");
  console.error(
